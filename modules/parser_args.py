...
def parse_arguments():
    ...
    parser.add_argument("--stream_target_language", default=None, help="[DEPRECATED] Language to translate the stream to. Use --stream_transcribe <language> instead.", type=str, choices=VALID_LANGUAGES)
