...
def parse_arguments():
    ...
    #parser.add_argument("--auto_language_lock", action='store_true', help="Automatically locks the language based on the detected language after set amount of transcriptions.")    parser.add_argument("--model_dir", default="models", help="Location where to store downloaded models.")
