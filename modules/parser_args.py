...
def parse_arguments():
    ...
    output_grp.add_argument("--serverip", default="0.0.0.0", type=str, help="IP address for the web server to bind to. Use 0.0.0.0 to listen on all interfaces (default), 127.0.0.1 for localhost only, or a specific IP available on your machine.")
